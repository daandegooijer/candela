  ...
  const videos = [
    {
      ...
      thumbnail: 'https://images.pexels.com/photos/7520390/pexels-photo-7520390.jpeg?auto=compress&cs=tinysrgb&w=400',
      duration: '3:45',
    },
    {
      id: 2,
      title: 'Amazing Grace - Live optreden',
      thumbnail: 'https://images.pexels.com/photos/8520626/pexels-photo-8520626.jpeg?auto=compress&cs=tinysrgb&w=400',
      duration: '4:20',
    },
    {
      id: 3,
      title: 'Repetitie impressie',
      thumbnail: 'https://images.pexels.com/photos/7520408/pexels-photo-7520408.jpeg?auto=compress&cs=tinysrgb&w=400',
      duration: '2:15',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex gap-4 mb-8 border-b border-gray-200">
          <button
            ...
            className={`px-6 py-3 font-semibold transition-colors flex items-center gap-2 ${
              activeTab === 'photos'
                ? 'text-[#0066B3] border-b-2 border-[#0066B3]'
                : 'text-gray-600 hover:text-[#0066B3]'
            }`}
          >
                ...
                <div className="relative">
                  ...
                  <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                    <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center hover:scale-110 transition-transform cursor-pointer">
                      <Play className="h-8 w-8 text-[#0066B3] ml-1" fill="currentColor" />
                    </div>
                  </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4 flex-1">
                    <button className="w-12 h-12 bg-[#0066B3] rounded-full flex items-center justify-center hover:bg-[#004d8a] transition-colors">
        ...
        <div className="mt-16 bg-gradient-to-r from-[#0066B3] to-[#004d8a] rounded-xl p-8 text-white text-center">
          <h2 className="text-2xl font-bold mb-4">Volg ons op social media</h2>
          <p className="text-blue-100 mb-6">
            Blijf op de hoogte van onze laatste optredens en achter-de-schermen beelden
          </p>
          <div className="flex gap-4 justify-center">
            <a
              ...
              className="px-6 py-3 bg-white text-[#0066B3] rounded-lg font-semibold hover:bg-blue-50 transition-colors"
            >
              Instagram
            </a>
            <a
